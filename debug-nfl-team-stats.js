...
async function debugNFLTeamStats() {
  console.log('Debugging NFL Team Stats...\n');

  const scoreboardUrl = `${ESPN_BASE}/football/nfl/scoreboard`;
  ...
  const boxScoreUrl = `${ESPN_BASE}/football/nfl/summary?event=${gameId}`;
